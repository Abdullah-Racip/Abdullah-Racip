...
digital forensics, and post-quantum cryptography — right now I'm working through CEHv13
training and just wrapped my first CTF competition.

## What I work with

| Area | Tools / Focus |
|---|---|
| OS | Kali Linux, Windows Servers |
| Recon & Exploitation | Nmap, Burp Suite, Metasploit |
| Analysis | Wireshark |
